...
- Contacts table columns are click-to-sort (name, company, first met, last meeting, next meeting, meeting count) and width-capped so long names/companies no longer stretch the layout
